...
export const TaskDetails = ({ values }) => {
  ...
  const GetSubmittedTask = async () => {
    await axios
      .get(`https://testserver.ezitech.org/get-submit-task/${values.taskId}`)
      .then((res) => {
        setData(res.data);
      })
      .catch((err) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (review.points !== undefined && review.desc !== undefined) {
      await axios
        .put(`https://testserver.ezitech.org/submit-review/${values.taskId}`, {
          review,
        })
        .then((res) => {
          alert(res.data.msg);
  ...
  const ApprovedTask = async () => {
    await axios
      .put(`https://testserver.ezitech.org/approve-task/${values.taskId}`)
      .then((res) => {
        alert(res.data.msg);
        window.location.reload();
      })
  ...
  const RejectTask = async () => {
    await axios
      .put(`https://testserver.ezitech.org/reject-task/${values.taskId}`)
      .then((res) => {
        alert(res.data.msg);
        window.location.reload();
      })
